...
export function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen overflow-hidden">
      ...
      >
        <Image
          src="/luxury-spa-minimalist-beauty-products-marble-surfa.jpg"
          alt="AURA Beauty - Luxury skincare products in minimalist spa setting with natural elements"
          fill
        ...
        <div className="container-custom text-center text-white">
          <Reveal>
            <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold leading-none tracking-tight mb-6">
              <AnimatedText text="Luxury beauty for" delay={0.5} />
              <br />
              <span className="italic font-light">
                <AnimatedText text="skin that glows." delay={1.1} />
              </span>
            </h1>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            ...
            >
              Formulated with Hyaluronic Acids, crafted for radiance — transformative skincare for modern beauty.
            </motion.p>
          </Reveal>
        </div>
      </motion.div>
        ...
        <BlurPanel className="mx-6 mb-6 px-6 py-4 bg-black/24 backdrop-blur-md border-white/20">
          <div className="flex items-center justify-center gap-6 text-white/90">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">Delivered in 3-5 days</span>
            </div>
            <div className="flex items-center gap-2">
